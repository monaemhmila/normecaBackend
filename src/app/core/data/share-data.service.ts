...
export class ShareDataService {
  ...
  public sideBar : header[] = [
    ...
    },
    {
      ...
      menu: [
        {
          menuValue: 'Process & Parc machines',
        ...
        {
          menuValue: 'Gestion et Management',
