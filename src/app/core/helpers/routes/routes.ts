...
export class routes {
  ...
  public static get blog(): string {
    return this.baseUrl + '/Savoirfaire';
  }
  ...
  public static get DEVIS(): string {
    return this.baseUrl + '/DevisGratuit';
  }
  ...
  public static get blog_list(): string {
    return this.blog + '/machines';
  }
  public static get blog_grid(): string {
    return this.blog + '/bureau';
  }
  public static get blog_details(): string {
    return this.blog + '/management';
  }
