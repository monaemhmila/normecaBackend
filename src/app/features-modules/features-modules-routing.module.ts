...
const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { 
        path: 'about', 
        loadChildren: () => import('./home5/home5.module').then((m) => m.Home5Module) 
      }, 
      ...
      { 
        path: 'Products', // Add this route for Products
        loadChildren: () => import('./Products/projects.module').then((m) => m.ProjectsModule) 
      },
      { 
        path: 'DevisGratuit', 
        loadChildren: () => import('./devisgratuit/register.module').then((m) => m.RegisterModule) 
      },
